        ...
        <div>
          <div className="absolute top-20 flex flex-col justify-center w-[85vw]">
            ...
            <div className="flex flex-row justify-center items-center gap-5 my-5">
              <button onClick={e => setWhichGallery('f')} className={`${whichGallery === "f" ? selectedButton : buttons}`}>Films</button>
              <button onClick={e => setWhichGallery('m')} className={`${whichGallery === "m" ? selectedButton : buttons}`}>Modelling</button>
              <button onClick={e => setWhichGallery('t')} className={`${whichGallery === "t" ? selectedButton : buttons}`}>Theater</button>
            </div>
          </div>
